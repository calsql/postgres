-- suggested by Hunley in ahc_tool issue #6 as being our new unused indexes query
-- from John Berkus https://gist.github.com/jberkus/6b1bcaf7724dfc2a54f3
WITH table_scans AS (
    SELECT
        relid,
...
indexes AS (
    SELECT
        ...
        idx_stat.idx_scan,
        pg_relation_size (
            idx_stat.indexrelid ) AS index_bytes,
...
SELECT
    ...
    tablename,
    indexname,
    index_scan_pct scans_per_write,
    index_size,
    table_size
FROM
    index_groups;
